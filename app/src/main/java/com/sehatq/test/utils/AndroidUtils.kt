...
import com.sehatq.test.domain.exceptions.FileReaderException
...
object AndroidUtils {
    ...
    fun getVersionApp(): String {
        try {
            val pInfo: PackageInfo = App.appContext?.packageManager?.getPackageInfo(App.appContext?.packageName, 0)!!
